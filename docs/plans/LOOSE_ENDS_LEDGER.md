...
|------|-----------|-----------------|
| **Erosion / hydrology (real or distilled)** | WG9 FAKES structure with ridged-noise valleys/ranges — NO erosion sim needed for WG9 PARITY. Distilled-erosion (offline-learn→cheap-online) is a "BEAT WG9" enhancement. | After WG9-parity worldgen core lands. North-star vision §3.2. |
