...
pub(super) struct StaticHeightRuntime {
    ...
    grid_n: usize,
    pub(super) origin_x_m: f64,
    pub(super) origin_z_m: f64,
    pub(super) span_x_m: f64,
    pub(super) span_z_m: f64,
    ...
    pub(super) source_span_x_m: f64,
    pub(super) source_span_z_m: f64,
