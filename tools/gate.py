...
CHECKS = {
    "fast": [
        ...
        "worldgen_terrain/tests/mountain_fly_runtime_config_check.gd",
    ],
    "gpu": [
    ...
    "m3": [
        ...
        "worldgen_terrain/tests/ring_material_tint_check.gd",
    ...
    # baseline payload shape; they do not prove the live streaming runtime.
    "review_static": [
